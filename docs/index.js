                  ...
                  return Data_Foldable.for_(Control_Monad_Free_Trans.applicativeFreeT(Control_Coroutine.functorCoTransform)(Control_Monad_Aff.monadAff))(Data_Foldable.foldableMaybe)(Data_List.index(sts)(v.value0))(function (st) {
                      ...
                      return Control_Coroutine.transformCoTransformR(Control_Monad_Aff.monadRecAff)(Control_Monad_Aff.parallelParAff)(Control_Coroutine.transformCoTransformL(Control_Monad_Aff.monadRecAff)(Control_Monad_Aff.parallelParAff)(Control_Monad_Rec_Class.forever(Control_Monad_Free_Trans.monadRecFreeT(Control_Coroutine.functorTransform)(Control_Monad_Aff.monadAff))(Control_Coroutine.transform(Control_Monad_Aff.monadAff)(function (v1) {
                          return Control_Bind.bind(Data_Maybe.bindMaybe)(v1)(function (v2) {
                              return Data_List.index(v2)(v.value0);
                          });
                      })))($62.performAction(v.value1)(p)(st)))(Control_Monad_Rec_Class.forever(Control_Monad_Free_Trans.monadRecFreeT(Control_Coroutine.functorTransform)(Control_Monad_Aff.monadAff))(Control_Coroutine.transform(Control_Monad_Aff.monadAff)(modifying(v.value0))));
                  });
              };
          };
      };
              ...
              return function (__copy_v1) {
                  return function (__copy_r) {
                      ...
                      tco: while (true) {
                          ...
                          throw new Error("Failed pattern match at Thermite line 353, column 5 - line 356, column 50: " + [ v.constructor.name, v1.constructor.name, r.constructor.name ]);
                      };
                  };
              };
          };
                  ...
                  return function (v) {
                      return foldWithIndex(function (i) {
                          return function (st) {
                              return function (els) {
                                  var $70 = f(i);
                                  return Data_Semigroup.append(Data_Semigroup.semigroupArray)(els)($70.render(function ($94) {
                                      return k(Data_Tuple.Tuple.create(i)($94));
                                  })(p)(st)([  ]));
                              };
                          };
                      })(sts)([  ]);
...
(function(exports) {
  ...
  var IncrementN = (function () {
      function IncrementN(value0) {
          this.value0 = value0;
      };
      IncrementN.create = function (value0) {
          return new IncrementN(value0);
      };
      return IncrementN;
  })();
  var timer = (function () {
              ...
              return function (state) {
                  return function (v2) {
                      ...
                      var show2 = function (x) {
                          ...
                          throw new Error("Failed pattern match at Main line 730, column 5 - line 739, column 37: " + [ x.constructor.name ]);
                      };
                      var mm = ss / 60 | 0;
  ...
  var slideNumberIs = function (n) {
      return function (dictChoice) {
          return Data_Lens_Prism.prism(function (v) {
              ...
              throw new Error("Failed pattern match at Main line 67, column 3 - line 71, column 30: " + [ v.constructor.name ]);
          })(dictChoice);
      };
  };
  ...
  var slide9 = (function () {
      var example = Data_String.joinWith("\n")([ "_Left  \u2237 Prism' (Either a b) a", "_Right \u2237 Prism' (Either a b) b" ]);
      return Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
          return function (v) {
              return function (state) {
                  return function (v1) {
                      return [ React_DOM["h1'"]([ React_DOM.text("Two Counters") ]), React_DOM["p'"]([ React_DOM.text("The corresponding action type is") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("Either CounterAction CounterAction") ]) ]), React_DOM["p'"]([ React_DOM.text("i.e. we can either") ]), React_DOM["ul'"]([ React_DOM["li'"]([ React_DOM.text("Update the "), React_DOM["code'"]([ React_DOM.text("Left") ]), React_DOM.text(" counter, or") ]), React_DOM["li'"]([ React_DOM.text("update the "), React_DOM["code'"]([ React_DOM.text("Right") ]), React_DOM.text(" counter") ]) ]), React_DOM["p'"]([ React_DOM.text("We can handle the parts using prisms:") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text(example) ]) ]) ];
                  };
              };
          };
      });
  ...
  var slide8 = (function () {
      var example = Data_String.joinWith("\n")([ "_1 \u2237 Lens' (Tuple a b) a", "_2 \u2237 Lens' (Tuple a b) b" ]);
      return Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
          return function (v) {
              return function (state) {
                  return function (v1) {
                      return [ React_DOM["h1'"]([ React_DOM.text("Two Counters") ]), React_DOM["p'"]([ React_DOM.text("The state type for two counters is") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("Tuple CounterState CounterState") ]) ]), React_DOM["p'"]([ React_DOM.text("i.e. one "), React_DOM["code'"]([ React_DOM.text("CounterState") ]), React_DOM.text(" for each counter") ]), React_DOM["p'"]([ React_DOM.text("We can access the parts using lenses:") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text(example) ]) ]) ];
                  };
              };
          };
      });
  ...
  var slide6 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Composition in Thermite") ]), React_DOM["p'"]([ React_DOM.text("Preview:") ]), React_DOM["ul'"]([ React_DOM["li'"]([ React_DOM.text("State: record types and lists") ]), React_DOM["li'"]([ React_DOM.text("Action: sum types") ]), React_DOM["li'"]([ React_DOM.text("Render/Update: lenses, prisms and traversals") ]) ]), React_DOM["p'"]([ React_DOM.text("These slides are composed from several small components") ]), React_DOM["p'"]([ React_DOM.text("(check the source!)") ]) ];
              };
          };
      };
  });
  ...
  var slide31 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Links, questions?") ]), React_DOM["ul'"]([ React_DOM["li'"]([ React_DOM.text("paf31/purescript-thermite") ]), React_DOM["li'"]([ React_DOM.text("paf31.github.io/try-thermite") ]), React_DOM["li'"]([ React_DOM.text("purescript-contrib/purescript-profunctor-lenses") ]), React_DOM["li'"]([ React_DOM.text("zrho/purescript-opticui") ]), React_DOM["li'"]([ React_DOM.text("paf31/codemesh2016") ]) ]) ];
              };
          };
      };
  });
  var slide30 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Conclusion") ]), React_DOM["p'"]([ React_DOM.text("(Strong) profunctors are a very useful abstraction and design tool!") ]) ];
              };
          };
      };
  });
  ...
  var slide29 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Main Idea") ]), React_DOM["p'"]([ React_DOM.text("The "), React_DOM["code'"]([ React_DOM.text("UI") ]), React_DOM.text(" type can now become") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("type UI'' s t = s \u2192 Consumer (s \u2192 t) (Aff eff) Unit \u2192 Eff eff HTML") ]) ]), React_DOM["p'"]([ React_DOM.text("Since this is still "), React_DOM["code'"]([ React_DOM.text("Strong") ]), React_DOM.text(", we can continue using the "), React_DOM["code'"]([ React_DOM.text("Lens") ]), React_DOM.text(" operations!") ]) ];
              };
          };
      };
  });
  var slide28 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("React is a Coroutine") ]), React_DOM["p'"]([ React_DOM.text("We can model React's internal state as:") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("react \u2237 Consumer (state \u2192 state) (Aff _) Unit") ]) ]), React_DOM["p'"]([ React_DOM.text("If we can model our application as") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("app \u2237 Producer (state \u2192 state) (Aff _) Unit") ]) ]), React_DOM["p'"]([ React_DOM.text("then we can use fusion to run it") ]) ];
              };
          };
      };
  });
  var slide27 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Coroutine Fusion") ]), React_DOM["p'"]([ React_DOM.text("We can fuse Coroutines in many ways:") ]), React_DOM["table'"]([ React_DOM["thead'"]([ React_DOM["th'"]([ React_DOM.text("A") ]), React_DOM["th'"]([ React_DOM.text("B") ]), React_DOM["th'"]([ React_DOM.text("Result") ]) ]), React_DOM["tbody'"]([ React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Producer a") ]), React_DOM["td'"]([ React_DOM.text("Producer b") ]), React_DOM["td'"]([ React_DOM.text("Producer (Tuple a b)") ]) ]), React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Consumer a") ]), React_DOM["td'"]([ React_DOM.text("Consumer b") ]), React_DOM["td'"]([ React_DOM.text("Consumer (Tuple a b)") ]) ]), React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Producer a") ]), React_DOM["td'"]([ React_DOM.text("Consumer a") ]), React_DOM["td'"]([ React_DOM.text("Process") ]) ]), React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Producer a") ]), React_DOM["td'"]([ React_DOM.text("Transformer a b") ]), React_DOM["td'"]([ React_DOM.text("Producer b") ]) ]), React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Consumer b") ]), React_DOM["td'"]([ React_DOM.text("Transformer a b") ]), React_DOM["td'"]([ React_DOM.text("Consumer a") ]) ]), React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Transformer a b") ]), React_DOM["td'"]([ React_DOM.text("Transformer b c") ]), React_DOM["td'"]([ React_DOM.text("Transformer a c") ]) ]) ]) ]) ];
              };
          };
      };
  });
  var slide26 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Taxonomy of Coroutines") ]), React_DOM["table'"]([ React_DOM["thead'"]([ React_DOM["th'"]([ React_DOM.text("Coroutine") ]), React_DOM["th'"]([ React_DOM.text("Function") ]), React_DOM["th'"]([ React_DOM.text("Example") ]) ]), React_DOM["tbody'"]([ React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Process") ]), React_DOM["td'"]([ React_DOM["code'"]([ React_DOM.text("yield \u2237 Process m Unit") ]) ]), React_DOM["td'"]([ React_DOM.text("") ]) ]), React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Producer o") ]), React_DOM["td'"]([ React_DOM["code'"]([ React_DOM.text("emit \u2237 o \u2192 Producer o m Unit") ]) ]), React_DOM["td'"]([ React_DOM.text("File Upload") ]) ]), React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Consumer i") ]), React_DOM["td'"]([ React_DOM["code'"]([ React_DOM.text("await \u2237 Consumer i m i") ]) ]), React_DOM["td'"]([ React_DOM.text("File Download") ]) ]), React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Transformer i o") ]), React_DOM["td'"]([ React_DOM["code'"]([ React_DOM.text("transform \u2237 (i \u2192 o) \u2192 Transformer i o m Unit") ]) ]), React_DOM["td'"]([ React_DOM.text("Websocket") ]) ]) ]) ]) ];
              };
          };
      };
  });
  var slide25 = (function () {
      var example = Data_String.joinWith("\n")([ "data Producer o m a", "", "emit \u2237 \u2200 o m. o \u2192 Producer o m Unit", "", "instance monadProducer \u2237 Monad m \u21d2 Monad (Producer o m)", "", "example \u2237 Producer Result (Aff _) Unit", "example = do", "  res1 <- liftAff $ get \"/request/1\"", "  emit res1", "  res2 <- liftAff $ get \"/request/2\"", "  emit res2" ]);
      return Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
          return function (v) {
              return function (state) {
                  return function (v1) {
                      return [ React_DOM["h1'"]([ React_DOM.text("Coroutines") ]), React_DOM["p'"]([ React_DOM.text("We want to support multiple incremental return values") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text(example) ]) ]) ];
                  };
              };
          };
      });
  })();
  var slide24 = (function () {
      var example = Data_String.joinWith("\n")([ "data Aff eff a", "", "instance monadAff \u2237 Monad (Aff eff)", "", "example \u2237 Aff _ (Array Result)", "example = do", "  res1 <- get \"/request/1\"", "  res2 <- get \"/request/2\"", "  pure [res1, res2]" ]);
      return Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
          return function (v) {
              return function (state) {
                  return function (v1) {
                      return [ React_DOM["h1'"]([ React_DOM.text("Aff") ]), React_DOM["p'"]([ React_DOM.text("An asynchronous effect monad") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text(example) ]) ]) ];
                  };
              };
          };
      });
  })();
  var slide23 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Finding a place for Async/Effects") ]), React_DOM["p'"]([ React_DOM.text("Real applications need to deal with (asynchronous) effects:") ]), React_DOM["ul'"]([ React_DOM["li'"]([ React_DOM.text("AJAX") ]), React_DOM["li'"]([ React_DOM.text("Websockets") ]), React_DOM["li'"]([ React_DOM.text("Events") ]), React_DOM["li'"]([ React_DOM.text("etc.") ]) ]), React_DOM["p'"]([ React_DOM.text("These fit into the "), React_DOM["code'"]([ React_DOM.text("Profunctor") ]), React_DOM.text(" model nicely") ]) ];
              };
          };
      };
  });
  var slide22 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Other optics") ]), React_DOM["p'"]([ React_DOM.text("What optics correspond to operations on components?") ]), React_DOM["table'"]([ React_DOM["thead'"]([ React_DOM["th'"]([ React_DOM.text("Component") ]), React_DOM["th'"]([ React_DOM.text("Function") ]), React_DOM["th'"]([ React_DOM.text("Optic") ]) ]), React_DOM["tbody'"]([ React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Pair") ]), React_DOM["td'"]([ React_DOM["code'"]([ React_DOM.text("focus") ]) ]), React_DOM["td'"]([ React_DOM.text("Lens") ]) ]), React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("List") ]), React_DOM["td'"]([ React_DOM["code'"]([ React_DOM.text("foreach") ]) ]), React_DOM["td'"]([ React_DOM.text("(Indexed) Traversal") ]) ]), React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Tabs") ]), React_DOM["td'"]([ React_DOM["code'"]([ React_DOM.text("split") ]) ]), React_DOM["td'"]([ React_DOM.text("Prism") ]) ]), React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Cards") ]), React_DOM["td'"]([ React_DOM["code'"]([ React_DOM.text("?") ]) ]), React_DOM["td'"]([ React_DOM.text("Grate") ]) ]) ]) ]) ];
              };
          };
      };
  });
  var slide21 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Pure Profunctor Lenses") ]), React_DOM["p'"]([ React_DOM.text("In other words, we have:") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("focus \u2237 Lens a b \u2192 UI' b \u2192 UI' a") ]) ]), React_DOM["p'"]([ React_DOM.text("If you have a "), React_DOM["code'"]([ React_DOM.text("Strong") ]), React_DOM.text(" profunctor, you get these operations for free!") ]) ];
              };
          };
      };
  });
  var slide20 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Pure Profunctor Lenses") ]), React_DOM["p'"]([ React_DOM.text("An alternative formulation of lenses") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("type Lens a b = \u2200 p. Strong p \u21d2 p b b -> p a a") ]) ]), React_DOM["p'"]([ React_DOM.text("See "), React_DOM["code'"]([ React_DOM.text("purescript-profunctor-lenses") ]) ]) ];
              };
          };
      };
  });
  ...
  var slide19 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Pure Profunctor Lenses") ]), React_DOM.p([ React_DOM_Props.className("center") ])([ React_DOM.img([ React_DOM_Props.src("images/profunctor-lenses.png") ])([  ]) ]) ];
              };
          };
      };
  });
  var slide18 = (function () {
      var example = Data_String.joinWith("\n")([ "class Strong p where", "  strength \u2237 p a b \u2192 p (Tuple a c) (Tuple b c)" ]);
      return Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
          return function (v) {
              return function (state) {
                  return function (v1) {
                      return [ React_DOM["h1'"]([ React_DOM.text("OpticUI") ]), React_DOM.pre([ React_DOM_Props.className("center") ])([ React_DOM["code'"]([ React_DOM.text("type UI' s t = s \u2192 (t \u2192 Eff eff Unit) \u2192 Eff eff HTML") ]) ]), React_DOM["p'"]([ React_DOM.text("In fact it is a "), React_DOM["code'"]([ React_DOM.text("Strong") ]), React_DOM.text(" profunctor") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text(example) ]) ]) ];
                  };
              };
          };
      });
  ...
  var slide17 = (function () {
      ...
      return Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
          return function (v) {
              return function (state) {
                  return function (v1) {
                      return [ React_DOM["h1'"]([ React_DOM.text("OpticUI") ]), React_DOM.pre([ React_DOM_Props.className("center") ])([ React_DOM["code'"]([ React_DOM.text("type UI' s t = s \u2192 (t \u2192 Eff eff Unit) \u2192 Eff eff HTML") ]) ]), React_DOM["p'"]([ React_DOM["code'"]([ React_DOM.text("UI'") ]), React_DOM.text(" is a "), React_DOM["code'"]([ React_DOM.text("Profunctor") ]) ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text(example) ]) ]) ];
                  };
              };
          };
      });
  })();
  var slide16 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("OpticUI") ]), React_DOM.pre([ React_DOM_Props.className("center") ])([ React_DOM["code'"]([ React_DOM.text("type UI s = s \u2192 (s \u2192 Eff eff Unit) \u2192 Eff eff HTML") ]) ]), React_DOM["p'"]([ React_DOM.text("Not a "), React_DOM["code'"]([ React_DOM.text("Functor") ]), React_DOM.text(" or a "), React_DOM["code'"]([ React_DOM.text("Monad") ]) ]) ];
              };
          };
      };
  });
  var slide15 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("OpticUI") ]), React_DOM.pre([ React_DOM_Props.className("center") ])([ React_DOM["code'"]([ React_DOM.text("type UI s = s \u2192 (s \u2192 Eff eff Unit) \u2192 Eff eff HTML") ]) ]), React_DOM["ul'"]([ React_DOM["li'"]([ React_DOM.text("Also React-based, with a lensy API") ]), React_DOM["li'"]([ React_DOM.text("See "), React_DOM["code'"]([ React_DOM.text("zrho/purescript-opticui") ]) ]) ]) ];
              };
          };
      };
  });
  var slide14 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("A Brief History of the API") ]), React_DOM["ul'"]([ React_DOM["li'"]([ React_DOM.text("v0.1: Elm arch + React") ]), React_DOM["li'"]([ React_DOM.text("v0.3: Monadic actions") ]), React_DOM["li'"]([ React_DOM.text("...") ]), React_DOM["li'"]([ React_DOM.text("v0.10: Use purescript-react") ]) ]) ];
              };
          };
      };
  });
  var slide13 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Summary") ]), React_DOM["table'"]([ React_DOM["thead'"]([ React_DOM["th'"]([ React_DOM.text("Component") ]), React_DOM["th'"]([ React_DOM.text("Function") ]), React_DOM["th'"]([ React_DOM.text("Optic") ]) ]), React_DOM["tbody'"]([ React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Pair (same state)") ]), React_DOM["td'"]([ React_DOM["code'"]([ React_DOM.text("(<>)") ]) ]), React_DOM["td'"]([ React_DOM.text("") ]) ]), React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("Pair (independent)") ]), React_DOM["td'"]([ React_DOM["code'"]([ React_DOM.text("focus") ]) ]), React_DOM["td'"]([ React_DOM.text("Lens") ]) ]), React_DOM["tr'"]([ React_DOM["td'"]([ React_DOM.text("List") ]), React_DOM["td'"]([ React_DOM["code'"]([ React_DOM.text("foreach") ]) ]), React_DOM["td'"]([ React_DOM.text("Traversal") ]) ]) ]) ]) ];
              };
          };
      };
  });
  var slide11 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Many Counters") ]), React_DOM["p'"]([ React_DOM.text("If we have many counters, the state type becomes") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("List CounterState") ]) ]), React_DOM["p'"]([ React_DOM.text("and the action type becomes") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("Tuple Int CounterAction") ]) ]), React_DOM["p'"]([ React_DOM.text("Note: The action type now includes the index of the component to update") ]), React_DOM["p'"]([ React_DOM.text("In OpticUI, this is generalized to an (indexed) Traversal of states.") ]) ];
              };
          };
      };
  });
  var slide1 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("This Talk") ]), React_DOM["ul'"]([ React_DOM["li'"]([ React_DOM.text("Thermite API intro") ]), React_DOM["li'"]([ React_DOM.text("Techniques discovered") ]), React_DOM["li'"]([ React_DOM.text("Will assume some Haskell knowledge (e.g. Monad)") ]) ]) ];
              };
          };
      };
  });
  var slide0 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Front End Development with PureScript and Thermite") ]), React_DOM.p([ React_DOM_Props.className("center") ])([ React_DOM.text("Phil Freeman") ]), React_DOM.p([ React_DOM_Props.className("center") ])([ React_DOM["code'"]([ React_DOM.text("paf31/codemesh2016") ]) ]) ];
              };
          };
      };
  });
  ...
  var numberOfSlides = 33;
  var next = Data_Lens_Setter.over(slideNumber(Data_Profunctor_Strong.strongFn))(function ($281) {
      return (function (v) {
          return v % numberOfSlides;
      })(1 + $281 | 0);
  });
  var last = Data_Lens_Setter.set(slideNumber(Data_Profunctor_Strong.strongFn))(numberOfSlides - 1);
  var initialState = {
      slideNumber: 0, 
      sharedState: {
          counter1: 0, 
          ...
          counter3: 0, 
          counter4: 0, 
          counterList: Data_List.fromFoldable(Data_Foldable.foldableArray)([ 1, 2, 3 ])
      }
  };
  var incrementN = function (dictChoice) {
      return Data_Lens_Prism.prism(function ($282) {
          return IncrementN.create(Data_Tuple.fst($282));
      })(function (v) {
          if (v instanceof IncrementN) {
              return new Data_Either.Right(new Data_Tuple.Tuple(v.value0, Data_Unit.unit));
          };
          return new Data_Either.Left(v);
      })(dictChoice);
  };
  var hello = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Hello!") ]), React_DOM["ul'"]([ React_DOM["li'"]([ React_DOM.text("Twitter/GitHub: "), React_DOM["code'"]([ React_DOM.text("paf31") ]) ]), React_DOM["li'"]([ React_DOM.text("I write Haskell") ]), React_DOM["li'"]([ React_DOM.text("I work on PureScript") ]) ]) ];
              };
          };
      };
  });
  ...
  var eqSlidesAction = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof IncrementN && y instanceof IncrementN) {
  ...
  var counterList = function (dictStrong) {
      return Data_Lens_Lens.lens(function (v) {
          return v.counterList;
      })(function (v) {
          return function (v1) {
              var $233 = {};
              for (var $234 in v) {
                  if (v.hasOwnProperty($234)) {
                      $233[$234] = v[$234];
                  };
              };
              $233.counterList = v1;
  ...
  var slide10 = (function () {
      var outro = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
          return function (v) {
              return function (state) {
                  return function (v1) {
                      return [ React_DOM["p'"]([ React_DOM.text("Note:") ]), React_DOM["ul'"]([ React_DOM["li'"]([ React_DOM.text("Lenses and prisms can be derived in most cases") ]), React_DOM["li'"]([ React_DOM.text("PureScript can infer the correct lenses and prisms in some cases") ]) ]) ];
                  };
              };
          };
      });
      var intro = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
          return function (v) {
              return function (state) {
                  return function (v1) {
                      return [ React_DOM["h1'"]([ React_DOM.text("Focusing") ]), React_DOM["p'"]([ React_DOM.text("Our component becomes:") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("focus _1 _Left counter <> focus _2 _Right counter") ]) ]) ];
                  };
              };
          };
      });
  ...
  var slide12 = (function () {
      var outro = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
          return function (v) {
              return function (state) {
                  return function (v1) {
                      return [ React_DOM["p'"]([ React_DOM.text("See the todo list example for a more involved example") ]) ];
                  };
              };
          };
      });
      var intro = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
          return function (v) {
              return function (state) {
                  return function (v1) {
                      return [ React_DOM["h1'"]([ React_DOM.text("Many Counters") ]), React_DOM["p'"]([ React_DOM.text("Our component becomes:") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("foreach \\_ \u2192 counter") ]) ]) ];
                  };
              };
          };
      });
      var counters = Thermite.focus(function (dictStrong) {
          return counterList(dictStrong);
      })(function (dictChoice) {
          return incrementN(dictChoice);
  ...
  var slide4 = (function () {
      var example = Data_String.joinWith("\n")([ "type CounterState = Int", "data CounterAction = Increment", "", "counter = T.simpleSpec performAction render where", "  render send _ count _ =", "    [ button [ onClick \\_ \u2192 send Increment ]", "             [ text (show count) ]", "    ]", "", "  performAction Increment _ _ = void $ modifyState (add 1)" ]);
      var intro = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
          return function (v) {
              return function (state) {
                  return function (v1) {
  ...
  var slidesComponent = (function () {
      ...
      return Data_Foldable.fold(Data_Foldable.foldableArray)(Thermite.monoidSpec)([ slide(0)(slide0), slide(1)(hello), slide(2)(slide1), slide(3)(slide2), slide(4)(slide3), slide(5)(slide4), slide(6)(slide5), slide(7)(slide6), slide(8)(slide7), slide(9)(slide8), slide(10)(slide9), slide(11)(slide10), slide(12)(slide11), slide(13)(slide12), slide(14)(slide13), slide(15)(slide14), slide(16)(slide15), slide(17)(slide16), slide(18)(slide17), slide(19)(slide18), slide(20)(slide19), slide(21)(slide20), slide(22)(slide21), slide(23)(slide22), slide(24)(slide23), slide(25)(slide24), slide(26)(slide25), slide(27)(slide26), slide(28)(slide27), slide(29)(slide28), slide(30)(slide29), slide(31)(slide30), slide(32)(slide31) ]);
  })();
  var back = Data_Lens_Setter.over(slideNumber(Data_Profunctor_Strong.strongFn))(function ($283) {
      return (function (v) {
          return v % numberOfSlides;
      })((numberOfSlides - 1) + $283 | 0);
  });
  var navbar = (function () {
      var render = function (dispatch) {
          return function (v) {
  ...
  var main = function __do() {
      ...
      var $272 = Thermite.createReactSpec(mainComponent)(new Data_Tuple.Tuple(initialState, Data_Newtype.wrap(Data_Time_Duration.newtypeSeconds)(0.0)));
      return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
          var tick = function ($$this) {
              return function __do() {
                  ...
                  return $272.dispatcher($$this)(new Data_Either.Right(dur))();
              };
          };
          ...
          var spec$prime = (function () {
              var $274 = {};
              for (var $275 in $272.spec) {
                  if ($272.spec.hasOwnProperty($275)) {
                      $274[$275] = $272.spec[$275];
                  };
              };
              $274.componentWillMount = setupTimer;
              return $274;
          })();
          return function __do() {
              ...
              var v2 = Partial_Unsafe.unsafePartial(function (dictPartial) {
                  return Data_Functor.map(Control_Monad_Eff.functorEff)(function ($284) {
                      return Data_Maybe.fromJust(dictPartial)(Data_Nullable.toMaybe($284));
