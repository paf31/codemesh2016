...
(function(exports) {
                  ...
                  return function (v1) {
                      return [ React_DOM["div'"]((function () {
                          if (slide instanceof Intro) {
                              return [ React_DOM["h1'"]([ React_DOM.text("Front End Development with PureScript and Thermite") ]), React_DOM["p'"]([ React_DOM.text("Phil Freeman") ]) ];
                          };
                          if (slide instanceof S1) {
                              return [ React_DOM["h1'"]([ React_DOM.text("Intro") ]) ];
                          };
                          ...
                          if (slide instanceof End) {
                              return [ React_DOM["h1'"]([ React_DOM.text("Questions?") ]) ];
                          };
                          throw new Error("Failed pattern match at Main line 139, column 7 - line 164, column 53: " + [ slide.constructor.name ]);
                      })()) ];
                  };
              };
          };
  ...
  var next = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 57, column 1 - line 57, column 16: " + [ v.constructor.name ]);
  };
  var last = function (v) {
      return End.value;
  };
  var initialState = Intro.value;
  ...
  var back = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 80, column 1 - line 80, column 17: " + [ v.constructor.name ]);
  };
  var navbar = (function () {
      var render = function (dispatch) {
          return function (v) {
          ...
          return function (v) {
              return function (v1) {
                  var move = function (v2) {
                      ...
                      throw new Error("Failed pattern match at Main line 130, column 5 - line 130, column 23: " + [ v2.constructor.name ]);
                  };
  ...
  var main = Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
      ...
      return function __do() {
          ...
          var v1 = Partial_Unsafe.unsafePartial(function (dictPartial) {
              return Data_Functor.map(Control_Monad_Eff.functorEff)(function ($29) {
                  return Data_Maybe.fromJust(dictPartial)(Data_Nullable.toMaybe($29));
