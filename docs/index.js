...
(function(exports) {
              ...
              return function (state) {
                  return function (v2) {
                      ...
                      var show2 = function (x) {
                          ...
                          throw new Error("Failed pattern match at Main line 620, column 5 - line 629, column 37: " + [ x.constructor.name ]);
                      };
                      var mm = ss / 60 | 0;
  ...
  var slide25 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Blah") ]), React_DOM["p'"]([ React_DOM.text("blah") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("blah") ]) ]) ];
              };
          };
      };
  });
  var slide24 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Blah") ]), React_DOM["p'"]([ React_DOM.text("blah") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("blah") ]) ]) ];
  ...
  var slide18 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Blah") ]), React_DOM["p'"]([ React_DOM.text("blah") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("blah") ]) ]) ];
  ...
  var slide17 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Blah") ]), React_DOM["p'"]([ React_DOM.text("blah") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("blah") ]) ]) ];
  ...
  var slide16 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Profunctor Lenses") ]), React_DOM["p'"]([ React_DOM.text("blah") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("blah") ]) ]) ];
              };
          };
      };
  });
  var slide15 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("OpticUI") ]), React_DOM["p'"]([ React_DOM.text("Also React-based, with a lensy API") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("type UI s = (s -> Eff _ Unit) -> s -> HTML") ]) ]) ];
              };
          };
      };
  });
  var slide14 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("A Brief History of the API") ]), React_DOM["ul'"]([ React_DOM["li'"]([ React_DOM.text("v0.1: Elm Architecture + React") ]), React_DOM["li'"]([ React_DOM.text("v???: Monadic Actions") ]), React_DOM["li'"]([ React_DOM.text("v???: OpticUI") ]) ]) ];
              };
          };
      };
  });
  ...
  var next = Data_Lens_Setter.over(slideNumber(Data_Profunctor_Strong.strongFn))(function ($253) {
      return (function (v) {
          return v % 21;
      })(1 + $253 | 0);
  });
  ...
  var incrementN = function (dictChoice) {
      return Data_Lens_Prism.prism(function ($254) {
          return IncrementN.create(Data_Tuple.fst($254));
      })(function (v) {
  ...
  var main = function __do() {
      ...
      var $244 = Thermite.createReactSpec(mainComponent)(new Data_Tuple.Tuple(initialState, Data_Newtype.wrap(Data_Time_Duration.newtypeSeconds)(0.0)));
      return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
          var tick = function ($$this) {
              return function __do() {
                  ...
                  return $244.dispatcher($$this)(new Data_Either.Right(dur))();
              };
          };
          ...
          var spec$prime = (function () {
              var $246 = {};
              for (var $247 in $244.spec) {
                  if ($244.spec.hasOwnProperty($247)) {
                      $246[$247] = $244.spec[$247];
                  };
              };
              $246.componentWillMount = setupTimer;
              return $246;
          })();
          return function __do() {
              ...
              var v2 = Partial_Unsafe.unsafePartial(function (dictPartial) {
                  return Data_Functor.map(Control_Monad_Eff.functorEff)(function ($256) {
                      return Data_Maybe.fromJust(dictPartial)(Data_Nullable.toMaybe($256));
