...
(function(exports) {
  ...
  var slides = {
      prev: Data_List.Nil.value, 
      current: Slide.value, 
      next: Data_List.Nil.value
  };
  var next = Control_Category.id(Control_Category.categoryFn);
  var last = Control_Category.id(Control_Category.categoryFn);
  var first = Control_Category.id(Control_Category.categoryFn);
  var back = Control_Category.id(Control_Category.categoryFn);
  var slidesComponent = (function () {
      var render = function (dispatch) {
          return function (v) {
              return function (s) {
                  return function (v1) {
                      return [ React_DOM["h1'"]([ React_DOM.text("Thermite") ]), React_DOM["nav'"]([ React_DOM.a([ React_DOM_Props.href("#"), React_DOM_Props.onClick(function (v2) {
                          return dispatch(First.value);
                      }) ])([ React_DOM.text("\u21e6") ]), React_DOM.a([ React_DOM_Props.href("#"), React_DOM_Props.onClick(function (v2) {
          ...
          return function (v) {
              return function (v1) {
                  var move = function (v2) {
                      ...
                      throw new Error("Failed pattern match at Main line 81, column 7 - line 81, column 25: " + [ v2.constructor.name ]);
                  };
  ...
  var main = Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
      var component = Thermite.createClass(slidesComponent)(slides);
      return function __do() {
          ...
          var v1 = Partial_Unsafe.unsafePartial(function (dictPartial) {
              return Data_Functor.map(Control_Monad_Eff.functorEff)(function ($19) {
                  return Data_Maybe.fromJust(dictPartial)(Data_Nullable.toMaybe($19));
