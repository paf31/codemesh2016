...
(function(exports) {
  ...
  var slide4 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
  ...
  var slide12 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
  ...
  var slide10 = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
  ...
  var next = Data_Lens_Setter.over(slideNumber(Data_Profunctor_Strong.strongFn))(function ($170) {
      return (function (v) {
          return v % 21;
      })(1 + $170 | 0);
  });
  ...
  var increment = function (l) {
      return Data_Lens_Setter.over(function ($171) {
          return sharedState(Data_Profunctor_Strong.strongFn)(Data_Lens_Lens.cloneLens(l)(Data_Profunctor_Strong.strongFn)($171));
  ...
  var slide7 = (function () {
      ...
      var intro = Thermite.simpleSpec(Thermite.defaultPerformAction)(function (dispatch) {
          return function (v) {
              return function (state) {
                  return function (v1) {
                      return [ React_DOM["h1'"]([ React_DOM.text("Composing Components") ]), React_DOM["p'"]([ React_DOM.text("Components form a Monoid which gives us one type of composition:") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("twoCounters = counter <> counter") ]) ]) ];
                  };
              };
          };
      });
  ...
  var back = Data_Lens_Setter.over(slideNumber(Data_Profunctor_Strong.strongFn))(function ($172) {
      return (function (v) {
          return v % 21;
      })(20 + $172 | 0);
  });
  ...
  var main = Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
      ...
      return function __do() {
          ...
          var v1 = Partial_Unsafe.unsafePartial(function (dictPartial) {
              return Data_Functor.map(Control_Monad_Eff.functorEff)(function ($173) {
                  return Data_Maybe.fromJust(dictPartial)(Data_Nullable.toMaybe($173));
