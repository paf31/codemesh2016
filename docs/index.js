...
(function(exports) {
                  ...
                  return function (v1) {
                      return [ React_DOM["div'"]((function () {
                          ...
                          if (slide instanceof S1) {
                              return [ React_DOM["h1'"]([ React_DOM.text("Intro") ]), React_DOM["p'"]([ React_DOM.text("Thermite is a") ]), React_DOM["ul'"]([ React_DOM["li'"]([ React_DOM.text("React-based") ]), React_DOM["li'"]([ React_DOM.text("\"opinionated\"") ]) ]), React_DOM["p'"]([ React_DOM.text("UI library for PureScript") ]) ];
                          };
                          if (slide instanceof S2) {
                              return [ React_DOM["h1'"]([ React_DOM.text("Problems for UI Libraries") ]), React_DOM["p'"]([ React_DOM.text("UI libraries have to solve the following problems:") ]), React_DOM["ul'"]([ React_DOM["li'"]([ React_DOM.text("Multiple components") ]), React_DOM["li'"]([ React_DOM.text("3rd party components") ]), React_DOM["li'"]([ React_DOM.text("Async code (AJAX etc.)") ]) ]), React_DOM["p'"]([ React_DOM.text("Thermite uses PureScript's advanced type system features to solve these problems.") ]) ];
                          };
                          if (slide instanceof S3) {
                              return [ React_DOM["h1'"]([ React_DOM.text("Components") ]), React_DOM["p'"]([ React_DOM.text("Thermite components are defined by:") ]), React_DOM["ul'"]([ React_DOM["li'"]([ React_DOM.text("A state type") ]), React_DOM["li'"]([ React_DOM.text("An action type") ]), React_DOM["li'"]([ React_DOM.text("A function which renders the current state") ]), React_DOM["li'"]([ React_DOM.text("A function which updates the current state based on an action") ]) ]), React_DOM["p'"]([ React_DOM.text("See also: The Elm Architecture (TEA)") ]) ];
                          };
                          if (slide instanceof S4) {
                              return [ React_DOM["h1'"]([ React_DOM.text("Component Types") ]), React_DOM["pre'"]([ React_DOM["code'"]([ React_DOM.text("newtype Spec eff state props action = Spec\n  { performAction \u2237 PerformAction eff state props action\n  , render        \u2237 Render state props action\n  }\n\ntype PerformAction eff state props action\n  = action\n  \u2192 props\n  \u2192 state\n  \u2192 CoTransformer (Maybe state) (state \u2192 state) (Aff eff) Unit\n\ntype Render state props action\n  = (action \u2192 EventHandler)\n  \u2192 props\n  \u2192 state\n  \u2192 Array ReactElement\n  \u2192 Array ReactElement") ]) ]) ];
                          };
                          ...
                          if (slide instanceof S8) {
                              return [ React_DOM["h1'"]([ React_DOM.text("Focusing") ]) ];
                          };
                          if (slide instanceof S9) {
                              return [ React_DOM["h1'"]([ React_DOM.text("Tab Components") ]) ];
                          };
                          if (slide instanceof S10) {
                              return [ React_DOM["h1'"]([ React_DOM.text("Data Lists") ]) ];
                          };
                          if (slide instanceof S11) {
                              return [ React_DOM["h1'"]([ React_DOM.text("Task List Example") ]) ];
                          };
                          if (slide instanceof S12) {
                              return [ React_DOM["h1'"]([ React_DOM.text("Async") ]) ];
                          };
                          if (slide instanceof S13) {
                              return [ React_DOM["h1'"]([ React_DOM.text("Try Thermite") ]) ];
                          };
                          if (slide instanceof S14) {
                              return [ React_DOM["h1'"]([ React_DOM.text("") ]) ];
                          };
                          ...
                          throw new Error("Failed pattern match at Main line 143, column 7 - line 241, column 53: " + [ slide.constructor.name ]);
                      })()) ];
                  };
              };
          };
  ...
  var next = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 58, column 1 - line 58, column 17: " + [ v.constructor.name ]);
  };
  var last = function (v) {
      return S20.value;
  };
  ...
  var back = function (v) {
      ...
      throw new Error("Failed pattern match at Main line 81, column 1 - line 81, column 18: " + [ v.constructor.name ]);
  };
  var navbar = (function () {
      var render = function (dispatch) {
          return function (v) {
  ...
  var main = Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
      ...
      return function __do() {
          ...
          var v1 = Partial_Unsafe.unsafePartial(function (dictPartial) {
              return Data_Functor.map(Control_Monad_Eff.functorEff)(function ($45) {
                  return Data_Maybe.fromJust(dictPartial)(Data_Nullable.toMaybe($45));
