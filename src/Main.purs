...
import Data.Lens (Prism', prism, Lens, over, set, lens)
...
increment :: SlidesState -> SlidesState
increment = over (sharedState <<< fstCounter) (add 1)

increment2 :: SlidesState -> SlidesState
increment2 = over (sharedState <<< sndCounter) (add 1)
...
navbar = T.simpleSpec performAction render where
  ...
  performAction action _ _ = void $ T.cotransform (move action) where
    ...
    move Next        = next
    move Last        = last
    move Increment   = increment
    move Increment2  = increment2

slide0 :: forall props. T.Render SharedState props SlidesAction
slide0 dispatch _ slide _ =
  [ RD.h1' [ RD.text "Front End Development with PureScript and Thermite" ]
  , RD.h2' [ RD.text "Phil Freeman" ]
  ]

slide1 :: forall props. T.Render SharedState props SlidesAction
slide1 dispatch _ slide _ =
  [ RD.h1' [ RD.text "Intro" ]
...
slide2 :: forall props. T.Render SharedState props SlidesAction
slide2 dispatch _ slide _ =
...
slide3 :: forall props. T.Render SharedState props SlidesAction
slide3 dispatch _ slide _ =
...
slide4 :: forall props. T.Render SharedState props SlidesAction
slide4 dispatch _ slide _ =
...
slide5 :: forall props. T.Render SharedState props SlidesAction
slide5 dispatch _ slide _ =
...
slide6 :: forall props. T.Render SharedState props SlidesAction
slide6 dispatch _ state _ =
    [ RD.h1' [ RD.text "Counter Component" ]
    , RD.pre' [ RD.code' [ RD.text example ] ]
    , RD.p' [ RD.button [ RP.onClick \_ -> dispatch Increment ]
                        [ RD.text (show state.fstCounter) ]
            ]
    ]
  where
...
slide7 :: forall props. T.Render SharedState props SlidesAction
slide7 dispatch _ state _ =
...
slide8 :: forall props. T.Render SharedState props SlidesAction
slide8 dispatch _ slide _ =
...
slide9 :: forall props. T.Render SharedState props SlidesAction
slide9 dispatch _ state _ =
    [ RD.h1'  [ RD.text "Focusing" ]
...
slide10 :: forall props. T.Render SharedState props SlidesAction
slide10 dispatch _ slide _ =
...
slide11 :: forall props. T.Render SharedState props SlidesAction
slide11 dispatch _ slide _ =
...
slide12 :: forall props. T.Render SharedState props SlidesAction
slide12 dispatch _ slide _ =
...
slide13 :: forall props. T.Render SharedState props SlidesAction
slide13 dispatch _ slide _ =
...
slide14 :: forall props. T.Render SharedState props SlidesAction
slide14 dispatch _ slide _ =
  [ RD.h1' [ RD.text "Async" ]
  , RD.p'  [ RD.text "Or \"What's this cotransform thing about?\"" ]
  ]

slide15 :: forall props. T.Render SharedState props SlidesAction
slide15 dispatch _ slide _ =
...
slide16 :: forall props. T.Render SharedState props SlidesAction
slide16 dispatch _ slide _ =
...
slide17 :: forall props. T.Render SharedState props SlidesAction
slide17 dispatch _ slide _ =
...
slide18 :: forall props. T.Render SharedState props SlidesAction
slide18 dispatch _ slide _ =
...
slide19 :: forall props. T.Render SharedState props SlidesAction
slide19 dispatch _ slide _ =
...
slide20 :: forall props. T.Render SharedState props SlidesAction
slide20 dispatch _ slide _ =
